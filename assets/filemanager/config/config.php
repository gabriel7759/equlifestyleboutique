...
//$base_url="http://elsardinero.cl.mx";  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = '/assets/files/content/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../files/content/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../files/cthumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
