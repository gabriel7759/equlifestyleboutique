			...
			<div class="box-body">
				<form name="list" action="" method="get" class="clearfix" data-token="<?=Security::token()?>">
					...
					<ul class="box-search clearfix">
						...
						<li>
							<label><?=__('Text')?> <span>(Role name)</span></label>
						...
						<table>
							<tbody>
								<tr>
									...
									<th width="320" class="sortable asc" abbr="sys_role.name" title="<?=__('Sort by role')?>"><?=__('Role')?></th>
									<th class="sortable asc" abbr="sys_role.last_modified" title="<?=__('Sort by last modified')?>"><?=__('Last modified')?></th>
